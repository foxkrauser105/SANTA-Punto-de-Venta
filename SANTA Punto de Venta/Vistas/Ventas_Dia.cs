        ...
        private void textBoxFinal_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F9)
            {
                ...
                else
                {
                    ...
                    if (con.ShowDialog(this) == DialogResult.Yes && con.textBoxContraseña.Text.Equals(Properties.Settings.Default.Pass))
                    {
                    ...
                    if (con.DialogResult == DialogResult.Yes && !con.textBoxContraseña.Text.Equals(Properties.Settings.Default.Pass))
                    {
